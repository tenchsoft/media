# Implementation Plan: Subtitle Style Font Size Minus

## Feature ID
player/subtitle-style-font-size-minus

## Spec Reference
`plans/spec/player/subtitle-style-font-size-minus.md`

## Design Reference
`plans/design/player/subtitle-style-font-size-minus.md`
