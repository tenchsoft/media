# Implementation Plan: External Subtitle Offset Plus

## Feature ID
player/external-subtitle-offset-plus

## Spec Reference
`plans/spec/player/external-subtitle-offset-plus.md`

## Design Reference
`plans/design/player/external-subtitle-offset-plus.md`

## Implementation Strategy

### Locate
- File: `apps/player/src-tauri/src/ui/paint_panels.rs`
- Search: `grep -n "subtitle_offset\|offset.*plus" apps/player/src-tauri/src/ui/paint_panels.rs`
